 ...
 *
 * 实现原理就是把整个body用css隐藏掉再javascript代替手动确认按钮而提交表单跳转即可
 *
 * @作者 田应平
 * @版本 v1.0
 * @创建时间 2020-05-02 16:41
 * @QQ号码 444141300
...
public class SupportController{
    ...
    private static String TEMPLATE = "<html><body>"
        + "<div style='display:none'><h1>OAuth Approval</h1><p>Do you authorize '${authorizationRequest.clientId}' to access your protected resources?</p>"
        ...
        + "%denial%</div>"
        + "<script type='text/javascript'>document.getElementById('confirmationForm').submit();</script></body></html>";
